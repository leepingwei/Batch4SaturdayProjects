...
public class PriceForOneLaptop {
    ...
    public int getPrice(int laptopID){
        ...
        price += calculation.getSize(data.AllData(laptopID));
        price += calculation.getRam(data.AllData(laptopID));
        price += calculation.getCPU(data.AllData(laptopID));
        price += calculation.getColor(data.AllData(laptopID));
