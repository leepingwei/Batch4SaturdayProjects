...
public class User {
    ...
    public static String checkAge(String myDOB) {
        ...
        LocalDate dob = LocalDate.parse(myDOB, formatter);
...
//        Period age = Period.between(dob, now);
        ...
        return isEligible ? "You can get a credit card." : "You should be at least 18 years old to get a credit card.";
    }
    ...
    public void transfer(User own, User other) {
        ...
        if (userAnswer.equalsIgnoreCase("different")) {
            System.out.print("Enter amount of money you want to transfer:\t");
            int amount = scanner.nextInt();
