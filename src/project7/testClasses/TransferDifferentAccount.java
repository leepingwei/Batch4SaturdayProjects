...
public class TransferDifferentAccount {
    ...
    static public void main(String[] args) {
        ...
        User u1 = new User("David" , "Villa", "10/02/2000", "married" ,1000 , 2000);
        User u2 = new User("Xavi" , "Hernandes", "11/12/1998", "single" ,3000 , 2000);
        u1.transfer(u1,u2);
        System.out.println(u1);
        System.out.println(u2);
        Assert.assertTrue("result should be 800 but your result is " +u1.amountAccount1 ,u1.amountAccount1==800);
